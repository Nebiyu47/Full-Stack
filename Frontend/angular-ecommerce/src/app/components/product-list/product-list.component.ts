...
export class ProductListComponent implements OnInit {
  ...
  handleSearchProducts() {
    ...
    this.productServices.getProductListSearchPagination(this.thePageNumber-1,
      this.thePageSize,
  ...
  handleListProducts() {
    ...
    console.log(`currentCategoryId=${this.currentCategoryId},thpageNumber=${this.thePageNumber}`)

    this.productServices.getProductListPagination(this.thePageNumber - 1, this.thePageSize, this.currentCategoryId).subscribe(
      this.processResult()
    )
  }
  updatedPageSize(pageSize: string){
